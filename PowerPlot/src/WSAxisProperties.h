...
typedef NS_ENUM(NSInteger, WSAxisStyle) {
...
typedef NS_ENUM(NSInteger, WSGridStyle) {
    kGridNone = -1, ///< No grid.
...
typedef NS_ENUM(NSInteger, WSLabelStyle) {
...
/// axis in a @p WSPlotAxis plot. Each @p WSPlotAxis object has two
/// instances of this class, one for the X- and one for the Y-axis.
