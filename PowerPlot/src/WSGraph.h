...
/** @return Graph with nodes and connections (factory method). */
...
/** @return Te total number of connections. */
...
/** @return Minimum connection strength. */
- (NAFloat)minimumStrength;

/** @return Maximum connection strength. */
