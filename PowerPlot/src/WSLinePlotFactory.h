...
/** @brief This category defines factory methods for line plots.
    ...
    This category defines a series of factory methods providing charts
    with line plots based on commonly used designs. The user can
    choose several default styles and methods to display the
    ...
    each plot in the chart has a single data set and coordinate system
    only!  When adding custom plots the user may or may not follow
    this behavior.
 */
