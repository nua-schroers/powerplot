...
/// Data source for @p WSPlotCustomView.
...
/** Data source for the custom views. */
@property (nonatomic, weak) id<WSPlotCustomViewDataSource> dataSource;

/** Positioning rule before applying the offset. Defaults to @p
    kCustomPositioningCenter.
*/
@property (nonatomic) WSCustomPositioning customPositioning;

/** Offset in X-direction applied when placing the custom
    view. Defaults to 0.
*/
@property (nonatomic) NAFloat offsetX;

/** Offset in Y-direction applied when placing the custom
    view. Defaults to 0.
*/
